...
/**
 * CoGrouping and dumping json flat object
 *
 * <p>How to run example:
 *
 * <p>sudo -u hdfs spark2-submit --conf spark.default.parallelism=100 --conf
 * spark.executor.memoryOverhead=4000 --class org.gbif.pipelines.labs.indexing.EsCoGroupFlatPipeline
 * --master yarn --deploy-mode cluster --executor-memory 12G --executor-cores 8 --num-executors 16
...
public class EsCoGroupFlatPipeline {
  ...
  private static final Logger LOG = LoggerFactory.getLogger(EsCoGroupFlatPipeline.class);

  public static void main(String... args) {
    avrosToText(args);
  }

  public static void avrosToText(String... args) {
    avrosToText(DataPipelineOptionsFactory.create(args));
  }

  public static void avrosToText(DataProcessingPipelineOptions options) {
            ...
            ParDo.of(
                new DoFn<KV<String, CoGbkResult>, String>() {
                  ...
                  public void processElement(ProcessContext c) {
                    ...
                    c.output(
                        ExtendedOccurrenceMapper.map(
                                interRecord, location, temporal, taxon, multimedia)
                            .toString());
                  }
                }));
